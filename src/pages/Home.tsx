...
export default function Home() {
  ...
  return (
    <motion.div
      className="min-h-screen font-sans px-4 sm:px-6 relative overflow-hidden bg-black text-white"
    >
  ...
  className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center text-gradient bg-clip-text px-2 drop-shadow-lg"
>
  WELCOME TO THE GREEK GOD SQUAD
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pb-20 max-w-6xl mx-auto">
        ...
        <LazyLoadingContent>
          <div className="space-y-10">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              className="bg-gray-800 border border-gray-700 p-6 rounded-xl shadow-md hover:shadow-lg transition"
            >
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[{
                  ...
                  <motion.div
                    key={idx}
                    className="flex flex-col items-center text-center bg-gray-800 rounded-xl p-6 border border-gray-600 shadow-sm hover:shadow-lg transition"
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="w-full md:max-w-md mx-auto bg-gray-900 border border-gray-700 p-6 rounded-xl shadow-md self-start hover:shadow-lg transition"
        >
      ...
      <footer className="text-center py-6 text-gray-400 px-4 text-sm font-bold">
